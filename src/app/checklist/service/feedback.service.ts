...
feedbackEscolhas(topicCounts: number[]): string {
  const feedbackBase = [
    {
      array: [0,4,6,1,2],
      text: '🗣 Avaliação: Mais do que o visual, para um bom grafico em Linguagem Simples, deve ser prezado a forma de como as informações são apresentadas.<br> 💡 Dica: Complemente mais os detalhes e as formas do seu gráfico para uma melhor demostração'
    },
    {
      array: [4,0,1,0,1],
    ...
    {
      array: [2,5,3,2,4],
      text: '🗣 Avaliação: Parabéns! Sua seleção mostra um equilíbrio saudável entre todos os elementos da visualização. Isso indica uma preocupação com clareza, acessibilidade, estética e organização.<br>💡 Dica: Continue assim!'
    },
    {
      array: [3,5,1,1,1],
      text: '🗣 Avaliação: Você deu bastante atenção ao uso de formas e cores — o que torna o gráfico atraente e legível. Porém, ignorar os eixos e a legenda pode comprometer a interpretação precisa dos dados.<br>💡 Dica: Não esqueça que bons dados também precisam de bons rótulos e escalas. Considere adicionar mais informações de eixos e legendas.'
    },
    {
      array: [1,8,1,1,1],
    ...
    {
      array: [2,3,2,2,3],
      text: '🗣 Avaliação: Você está no caminho certo! Sua seleção é equilibrada e cobre os principais aspectos de um bom gráfico: estrutura, estética, acessibilidade e clareza. Mas ainda há espaços para melhoria<br> 💡 Dica: Dê mais atenção aos eixos e aos detalhes para uma visualização mais rica.'
    },
    {
      array: [0,0,0,0,6],
      text: '🗣 Avaliação: Seu gráfico está muito focado nos detalhes mas não no todo.<br>💡 Dica: Utilize mais das outras etapas para uma visualização mais correta'
    },
    {
      array: [1,9,1,0,0],
      text: '🗣 Avaliação: Sua atenção à paleta de cores é exemplar — isso contribui para acessibilidade, consistência e estética. Porém, o gráfico pode ser visualmente agradável mas tecnicamente frágil.<br> 💡 Dica: Considere reforçar os eixos, a legenda e os detalhes para complementar o excelente trabalho com as cores.'
    },
    {
      array: [3,0,5,0,0],
      text: '🗣 Avaliação: Você criou uma base sólida de estrutura e forma. O gráfico tende a ser compreensível e objetivo, mas pode parecer desconexo e sem detalhamento.<br> 💡 Dica: Busque conferir as legendas e melhore nos detalhes.'
    },
    {
      array: [1,2,1,2,1],
      text: '🗣 Avaliação: Você tocou pontos importantes, mas não esta atento aos detalhes.<br> 💡 Dica: Dê um pouco mais de foco aos detalhes para uma demonstração mais coesa e rica.'
    },
    {
      array: [1,1,1,1,1],
    ...
    {
      array: [2,5,1,0,6],
      text: '🗣 Avaliação: Você absorveu bem a ideia de demonstração visual no seu gráfico, contanto, as informações podem ser mal interpretadas.<br> 💡 Dica: Dê mais atenção aos eixos e legendas do seu gráfico a fim de manter a proporção e deixa-lo mais legível.'
    }
  ];
